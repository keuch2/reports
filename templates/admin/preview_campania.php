...
<section class="shell__body">
    ...
    <div class="kpi-grid">
        ...
        <?php endif; ?>
        <?php
        // Solo métricas secundarias relevantes al objetivo (mismo criterio que
        // el detalle de campaña del cliente): oculta conversaciones/leads/visitas
        // residuales que Meta reporta pero no son el objetivo (p. ej. 2
        // conversaciones en una campaña de awareness).
        ?>
    ...
    <?php
    // Desglose por tipo, filtrado a las métricas relevantes al objetivo.
